...
os.environ["PATH"] += os.pathsep + "I:/graphviz-2.38/bin"

model = densenet121_model(224, 224)
keras.utils.plot_model(model, to_file="J:/model.png", show_shapes=True)